...
import DatasetChart from "../../backbone/DatasetChart";
import DatasetSeriesTable from "../../backbone/DatasetSeriesTable";
...
export default function Detail() {
  ...
  return (
    <section className="py-6" style={{ marginTop: "50px", marginBottom: "50px" }}>
