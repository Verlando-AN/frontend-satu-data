...
import { Search, Filter, X, Calendar, Building2, BookOpen } from "lucide-react";
...
export default function Publikasi() {
  ...
  const filteredData = useMemo(() => {
    return publikasiData.filter(item => {
      const matchesSearch = item.buku.toLowerCase().includes(searchQuery.toLowerCase()) ||
                           item.nama_opd.toLowerCase().includes(searchQuery.toLowerCase());
      
      const itemYear = new Date(item.created_at * 1000).getFullYear().toString();
     ...
     <div className="cari-filter-wrapper">
        <div className="filter-controls">
          ...
          <div className="results-count">
            ...
            <span className="count-text"> dari {publikasiData.length} publikasi</span>
          </div>
          ...
          {filteredData.map((item, index) => {
            ...
            return (
              <div key={index} className="book-card">
                <Link to={`/publikasi/buku/${item.buku_slug}`} className="book-link">
                    ...
                    <div className="book-content">
                      ...
                      <div className="book-details">
                        ...
                        <div className="detail-item">
                          ...
                          <div className="detail-text">
                            <span className="detail-label">Tanggal Publikasi</span>
